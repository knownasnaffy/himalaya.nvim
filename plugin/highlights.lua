...
vim.api.nvim_set_hl(0, "HimalayaFolderActive", { fg = vim.api.nvim_get_hl(0, { name = "Directory" }).fg, bold = true })
vim.api.nvim_set_hl(0, "HimalayaFolderDisabled", { fg = vim.api.nvim_get_hl(0, { name = "Comment" }).fg })
